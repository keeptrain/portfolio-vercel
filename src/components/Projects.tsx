...
export default function Projects({ locale }: ProjectsProps) {
  const projects = [
    {
      id: 1,
      title: t(locale, "projects.ecommerce.title"),
      description: t(locale, "projects.ecommerce.description"),
    ...
    {
      id: 2,
      title: t(locale, "projects.taskmanager.title"),
      description: t(locale, "projects.taskmanager.description"),
    ...
    {
      id: 3,
      title: t(locale, "projects.weather.title"),
      description: t(locale, "projects.weather.description"),
