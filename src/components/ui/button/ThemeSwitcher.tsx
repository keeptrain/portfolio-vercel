        ...
        {options.map((option) => {
          return (
            <button
              ...
              className={`cursor-pointer rounded-full p-1.5 text-gray-500 transition-all duration-150 hover:text-gray-800 dark:text-zinc-50 ${theme === option ? "border-gray-200 bg-black/5 text-gray-800 dark:bg-zinc-700" : "border-transparent bg-transparent"}`}
