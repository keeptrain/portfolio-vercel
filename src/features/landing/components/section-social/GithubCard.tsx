...
export default function GithubCard({
  ...
  return (
    <Link
      ...
      className={`group relative flex aspect-4/3 w-full items-center justify-center overflow-hidden rounded-xl bg-zinc-900 p-4 transition-all duration-300 hover:bg-zinc-800 ${className}`}
    >
