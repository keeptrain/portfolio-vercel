...
const SOCIAL_ITEMS: SocialItem[] = [
  ...
  },
  {
    ...
    bgColor: "bg-[#E2E8F0] dark:bg-zinc-800",
  },
  {
    id: "github",
    name: "GitHub",
          ...
          <CarouselItem key={item.id}>
            <Link href={item.url} target="_blank" rel="noopener noreferrer">
              ...
              >
                ...
                {item.id === "linkedin" ? (
                  <span className="font-sans text-6xl font-extrabold tracking-tighter text-white sm:text-7xl">
                    in
                  </span>
                ) : item.id === "email" ? (
                  <span className="font-sans text-3xl font-bold tracking-tight text-zinc-800 sm:text-4xl dark:text-white">
                    email
                  </span>
                ) : (
                  <svg
                    className="size-16 fill-white sm:size-20"
                    viewBox="0 0 24 24"
                  >
                    <path
                      fillRule="evenodd"
